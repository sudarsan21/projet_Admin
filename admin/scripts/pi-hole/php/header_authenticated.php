...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg">EYE-<strong>SPOT</strong></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <a class="btn-link" href="https://instagram.com/follow_pannuriya_da_body_soda_?igshid=YmMyMTA2M2Y=" rel="noopener" target="_blank">
                                    <svg class="svg-inline--fa fa-fw menu-icon" style="height: 1.25em"><use xlink:href="img/pihole_icon.svg#pihole-svg-logo"/></svg>
                                    SUDARSAN
                                </a>
                                <hr>
                               <a class="btn-link" href="https://www.instagram.com/tharun_r2_creations/" rel="noopener" target="_blank"><i class="fa-fw menu-icon fab fa-github"></i> DHARUN_KUMAR(TEAM _LEADER)</a>
                                <a class="btn-link" href="https://www.instagram.com/single_.boy._kavin/" rel="noopener" target="_blank"><i class="fa-fw menu-icon fab fa-github"></i>KAVIN_KUMAR</a>
                                <a class="btn-link" href="https://www.instagram.com/call_me_lucifer_._/" rel="noopener" target="_blank"><i class="fa-fw menu-icon fab fa-github"></i>KAVIN_SANKAR</a>
                                <a class="btn-link" href="https://www.instagram.com/kuttima_8438/" rel="noopener" target="_blank"><i class="fa-fw menu-icon fab fa-github"></i>KOKILA </a>
                                 <a class="btn-link" href="" rel="noopener" target="_blank"><i class="fa-fw menu-icon fab fa-github"></i>YOGESHWARI</a>
                                 </hr>
